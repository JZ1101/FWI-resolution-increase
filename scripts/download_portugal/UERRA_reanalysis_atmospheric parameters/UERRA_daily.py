...
# Time: 2010–2017,  may to nov
YEARS = [str(year) for year in range(2010, 2018)]
MONTHS = [f"{month:02d}" for month in range(5, 12)]
DAYS = [f"{day:02d}" for day in range(1, 32)]
HOURS = ["00:00", "06:00", "12:00", "18:00"]  # 6-hourly intervals
VARIABLES = [
    "10m_wind_speed",
...
def download_yearly_data(client, year):
    ...
    output_file = os.path.join(OUTPUT_DIR, f"uerra_mescan_6hourly_may_nov_{year}.nc")
