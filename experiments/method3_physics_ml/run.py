#!/usr/bin/env python3
"""Run Method 3: Physics-Informed ML experiment"""
...
from src.models import PhysicsMLDownscaler
...
def main():
    ...
    logger.info("Starting Method 3: Physics-Informed ML")
    ...
    # Initialize Physics-ML model
    model = PhysicsMLDownscaler(
        upscale_factor=4,
        physics_weight=0.6,
    ...
    # Train the model
    logger.info("Training Physics-ML model...")
    ...
    trainer.save_model("physics_ml_2017")
    
    logger.info("Method 3 experiment completed")
